...
const PomoTimer = () => {
  ...
  const percentage = Math.round(secondLeft / totalSeconds);

  const red = "#f54e4e";
  const green = "#4aec8c";
  return (
    <div>
      <CircularProgressbar value={percentage} text={percentage} styles={buildStyles({textColor: `#fff`, pathColor: red, trailColor:  `rgba(255,255,255, .2)`,
    })}/>
