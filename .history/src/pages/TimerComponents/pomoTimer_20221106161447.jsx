...
const PomoTimer = () => {
  ...
  return (
    ...
    <div className="timer-btns">
      {isPaused ? <PlayButton isPaused={isPaused} setIsPaused={setIsPaused} isPausedRef/> : <PauseButton isPaused={isPaused} setIsPaused={setIsPaused} isPausedRef={isPausedRef}/>}
    </div>
    <div>
      <SettingButton/>
    </div>
