...
const PomoTimer = () => {
  ...
  const minutes = secondLeft / 60;
  const seconds = secondLeft % 

  const red = "#f54e4e";
  const green = "#4aec8c";
  return (
    <div>
      <CircularProgressbar value={percentage} text={minutes} styles={buildStyles({textColor: `#fff`, pathColor: red, trailColor:  `rgba(255,255,255, .2)`,
    })}/>
